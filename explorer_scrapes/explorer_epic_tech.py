...
from settings import FEED_API
try: from .base_scrape import ExplorerScrape
except: from base_scrape import ExplorerScrape


class EpicTechScrape(ExplorerScrape):
    api_url = FEED_API.EXPLORER_EPIC_TECH.API_URL
    api_calls = FEED_API.EXPLORER_EPIC_TECH.API_CALLS
    public_api_url = FEED_API.EXPLORER_EPIC_TECH.PUBLIC_API_URL
